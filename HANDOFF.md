...
_**✅ RETE DI SICUREZZA:** `python tools\controlla.py` — 51 controlli automatici (§sotto)._
...
```
51 controlli in ~3m. Apre il gioco in un browser invisibile (Playwright), inietta
