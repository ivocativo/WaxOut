...
window.I18n = (function () {
  ...
  const STRINGS = {
    en: {
      ...
      menu_goal_1: 'Travel down the ear canal, smashing through the wax membranes, until you reach the eardrum.',
      ...
      done_sub: 'You reached the eardrum!',
      // --- Game over ---
    ...
    it: {
      ...
      menu_goal_1: 'Attraversa il condotto sfondando le membrane di cerume, fino a raggiungere il timpano.',
      ...
      done_sub: 'Hai raggiunto il timpano!',
      // --- Game over ---
